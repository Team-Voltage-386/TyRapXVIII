...
public class ElevatorSubsystem extends Subsystem {
     ...
     * 
     * @param pov       The POV value (one of the 8 angle values available from the
     *                  DPad)
     * @param speedUp   The speed at which the elevator moves up
     * @param speedDown The speed the elevator moves down at
     */
     ...
     * @param down  Direction of travel False: down True: up
     */
     ...
     * 
     * @param value DOubleSolenoid.Value to set
     */
